...
function reInicializa(){
	txtNome.value = txtTexto.value = txtX.value =  txtY.value =  txtW.value =  txtH.value = txtClasses.value = /*txtCruds.value =*/ "";
	txtNome.disabled = txtTexto.disabled = txtX.disabled =  txtY.disabled =  txtW.disabled =  txtH.disabled = false;
}
        ...
        r.onload = function(e) { 
            ...
            if ((f.name).split(".").pop()=="xml"){
				...
				for (i=0;i<str.length;i++)
				{
					...
					impStartGoTo(idSGT, textoSGT, classeSGT, atributoSGT, xSGT, ySGT, wSGT, hSGT);
				}
				...
				for (i=0;i<str.length;i++)
				{
					...
					impStartGoTo2(idSGT, textoSGT, classeSGT, atributoSGT, xSGT, ySGT, wSGT, hSGT);
				}
				...
				for (i=0;i<str.length;i++)
				{
					...
					impStartGoTo3(idSGT, textoSGT, classeSGT, atributoSGT, xSGT, ySGT, wSGT, hSGT);
				}
				...
				for (i=0;i<vw.length;i++)
				{
					...
					impView(idV, textoV, classeV, atributoV, xV, yV, wV, hV);
				}
